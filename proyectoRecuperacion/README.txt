...
a persistence unit "proyectoRecuperacionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proyectoRecuperacion\pom.xml":
...
artifact ("proyectoRecuperacion.war") is already built. You can build
